 ...
 */
//mls@dev01 static TCB_t *prvAllocateTCBAndStack( const uint16_t usStackDepth, StackType_t * const puxStackBuffer ) PRIVILEGED_FUNCTION;
...
//    pxNewTCB = prvAllocateTCBAndStack( usStackDepth, puxStackBuffer );
    ...
    if( pxNewTCB != NULL )
    {
    		...
    		{
    			//pxNewTCB->pxStack = (( portSTACK_TYPE * )puxStackBuffer) + ((sizeof(tskTCB)+sizeof(portSTACK_TYPE))/sizeof(portSTACK_TYPE))*sizeof(portSTACK_TYPE);
    			pxNewTCB->pxStack = ( portSTACK_TYPE * )(((int)puxStackBuffer + sizeof (portSTACK_TYPE)-1)&(~(sizeof(portSTACK_TYPE)-1)));
    		}
    		else
    		{
