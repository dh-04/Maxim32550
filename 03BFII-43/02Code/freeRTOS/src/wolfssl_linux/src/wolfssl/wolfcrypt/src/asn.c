...
#include "../../inc/wolfcrypt/asn.h"
#include "../../inc/wolfcrypt/coding.h"
#include "../../inc/wolfcrypt/md2.h"
#include "../../inc/wolfcrypt/hmac.h"
#include "../../inc/wolfcrypt/error-crypt.h"
#include "../../inc/wolfcrypt/pwdbased.h"
#include "../../inc/wolfcrypt/des3.h"
#include "../../inc/wolfcrypt/logging.h"

#include "../../inc/wolfcrypt/random.h"
#include "../../inc/wolfcrypt/hash.h"
#ifdef NO_INLINE
...
#ifndef NO_SHA256
    #include "../../inc/wolfcrypt/sha256.h"
#endif

#ifdef HAVE_ECC
    #include "../../inc/wolfcrypt/ecc.h"
#endif
...
#ifdef STYL_MAXIM_GET_TIME
	#ifdef STYL_MAXIM_IGNORE_CHECK_TIME
    return 1; //vietdang: ignore check time
	#endif
#endif
...
{
#ifndef STYL_USE_OTHER_TIME_SOURCE
    int length;
    int badDate = 0;
    ...
    for(i = 0; i < MAX_TIME_SOURCE; i++)
    {
		...
		{
			//choose another source and continue
			timeChooseAnotherSource = True;
		}
    }
#endif
    return badDate;
