...
#include "../inc/wolfcrypt/settings.h"
...
#include "../inc/error-ssl.h"
#include "../inc/wolfcrypt/coding.h"
#ifdef NO_INLINE
    #include "../inc/wolfcrypt/misc.h"
#else
    ...
    #include "../inc/wolfcrypt/wc_encrypt.h"
#endif

#ifdef OPENSSL_EXTRA
    /* openssl headers begin */
    #include "../inc/openssl/hmac.h"
    #include "../inc/openssl/crypto.h"
    #include "../inc/openssl/des.h"
    #include "../inc/openssl/bn.h"
    #include "../inc/openssl/dh.h"
    #include "../inc/openssl/rsa.h"
    #include "../inc/openssl/pem.h"
    #include "../inc/openssl/ec.h"
    #include "../inc/openssl/ec25519.h"
    #include "../inc/openssl/ed25519.h"
    #include "../inc/openssl/ecdsa.h"
    #include "../inc/openssl/ecdh.h"
    /* openssl headers end, wolfssl internal headers next */
    #include "../inc/wolfcrypt/hmac.h"
    #include "../inc/wolfcrypt/random.h"
    #include "../inc/wolfcrypt/des3.h"
    #include "../inc/wolfcrypt/md4.h"
    #include "../inc/wolfcrypt/md5.h"
    #include "../inc/wolfcrypt/arc4.h"
    #include "../inc/wolfcrypt/idea.h"
    #include "../inc/wolfcrypt/curve25519.h"
    #include "../inc/wolfcrypt/ed25519.h"
    #ifdef HAVE_STUNNEL
        #include "../inc/openssl/ocsp.h"
    #endif /* WITH_STUNNEL */
    #ifdef WOLFSSL_SHA512
        #include "../inc/wolfcrypt/sha512.h"
    #endif
#endif

#ifdef NO_ASN
    #include "../inc/wolfcrypt/dh.h"
#endif
...
WOLFSSL_CTX* wolfSSL_CTX_new_ex(WOLFSSL_METHOD* method, void* heap)
{
    ...
    mlsDebugPrint("wolfSSL_CTX_new_ex XMALLOC: 0x%x ---------------------\r\n", ctx);
    if (ctx) {
