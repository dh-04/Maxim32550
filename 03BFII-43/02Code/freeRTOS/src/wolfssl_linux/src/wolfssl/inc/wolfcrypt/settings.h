...
/* Uncomment next line if building for setting of user */
...
//	#define LARGE_STATIC_BUFFERS
    ...
    //enable ciphers which NETS server supports:
	...
	#if STYL_MAXIM
//		#include "../../mlsApp/inc/mlsTrng.h"
#include "mlsTrng.h"
		//generate random number
		#define CUSTOM_RAND_GENERATE_SEED(buff, length)	mlsTrngGetBuf(buff, length)

    	//time
//		#define STYL_USE_OTHER_TIME_SOURCE
#ifdef STYL_USE_OTHER_TIME_SOURCE
		typedef enum
		{
			TIME_SOURCE_RTC,
			TIME_SOURCE_3G,
    	...
    	extern Bool timeChooseAnotherSource;
#endif
		#define STYL_MAXIM_GET_TIME
//		#define STYL_MAXIM_IGNORE_CHECK_TIME
		#define USER_TIME
		#ifndef NO_SHA256
			#define STYL_MAXIM_SHA256
		#endif

		#define STYL_MAXIM_AES				1

		#ifndef NO_SHA
			#define STYL_MAXIM_SHA
		#endif
		#ifndef NO_MD5
			#define STYL_MAXIM_MD5
		#endif
	#endif
