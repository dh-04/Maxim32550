 ...
 */
int ucl_3des_cfb(u8 *dataOut, u8 *dataIn, u8 *key, u8 *IV,
 ...
 * @ingroup UCL_CFB_3DES
 */
int ucl_3des_cfb_init(ucl_3des_ctx_t *ctx, u8 *key,
                      u8 *IV, int mode);
 ...
 * @ingroup UCL_CFB_3DES
 */
int ucl_3des_cfb_core(u8 *dataOut, ucl_3des_ctx_t *ctx,
