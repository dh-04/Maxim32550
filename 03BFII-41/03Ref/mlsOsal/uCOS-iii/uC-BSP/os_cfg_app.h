...
#define  OS_CFG_ISR_STK_SIZE						256u		//@stylvn016

#define  OS_CFG_MSG_POOL_SIZE						64u			/* Maximum number of messages                           */
...
#define  OS_CFG_TICK_TASK_STK_SIZE					100u		/* Stack size (number of CPU_STK elements)              */
                                                                ...
                                                                /* --------------------- TIMERS ----------------------- */
#define  OS_CFG_TMR_TASK_PRIO	/*(OS_CFG_PRIO_MAX-3u)*/4u		/* Priority of 'Timer Task'                             */
